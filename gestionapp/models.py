...
class Adherent(models.Model):
	...
	numero_securite_sociale = models.CharField(max_length=15, unique=True, help_text='Numero de securite sociale unique')
	date_adhesion = models.DateField(auto_now_add=True) # La date est ajoutee automatiquement à la création
...
class Cotisation(models.Model):
 	...
 	def __str__(self):
    		return f"Cotisation de {self.montant}euros pour {self.adherent} le {self.date_versement}"
